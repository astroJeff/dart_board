...
pub = dart_board.DartBoard("NSHMXB", evolve_binary=pybse.evolve, metallicity=0.008,
                           ln_prior_pos=sf_history.flat.prior_lmc, nwalkers=32,
...
# Pickle results
import pickle
pickle.dump(pub.chains, open("../data/J0513_flatsfh_PT_chain.obj", "wb"))
pickle.dump(pub.lnprobability, open("../data/J0513_flatsfh_PT_lnprobability.obj", "wb"))
pickle.dump(pub.sampler.tswap_acceptance_fraction, open("../data/J0513_flatsfh_PT_tswap.obj", "wb"))
pickle.dump(pub.sampler, open("../data/J0513_flatsfh_PT_sampler.obj", "wb")) 
