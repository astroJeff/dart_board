...
pub.throw_darts(nburn=2, nsteps=520000)
...
nchains, nsteps, nvar = pub.chains.shape
...
for j in range(nchains):
    for k in range(nsteps):
        ...
        pub.derived[j,k] = np.array([output])
...
# Save outputs
np.save("../data/J0513_nonPT_chain.npy", pub.chains)
np.save("../data/J0513_nonPT_derived.npy", pub.derived)
np.save("../data/J0513_nonPT_lnprobability.npy", pub.lnprobability)


# Pickle results
# import pickle
# pickle.dump(pub.chains, open("../data/J0513_chain.obj", "wb"))
# pickle.dump(pub.lnprobability, open("../data/J0513_lnprobability.obj", "wb"))
# pickle.dump(pub.derived, open("../data/J0513_derived.obj", "wb"))
