...
# Save outputs
np.save("../data/mock_3_high_chain.npy", pub.chains)
np.save("../data/mock_3_high_derived.npy", pub.derived)
np.save("../data/mock_3_high_lnprobability.npy", pub.lnprobability)
