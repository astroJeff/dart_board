...
# Save outputs
np.save("../data/J0513_nosfh_high_chain.npy", pub.chains)
np.save("../data/J0513_nosfh_high_derived.npy", pub.derived)
np.save("../data/J0513_nosfh_high_lnprobability.npy", pub.lnprobability)
