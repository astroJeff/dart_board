...
pub = dart_board.DartBoard("HMXB", evolve_binary=pybse.evolv_wrapper, nwalkers=50000)
pub.aim_darts()
...
import pickle
pickle.dump(pub.sampler.acceptance_fraction, open("test_n50000_accept_frac.dat", "wb"))
