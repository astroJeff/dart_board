...
# Save outputs
np.save("../data/mock_1_low_chain.npy", pub.chains)
np.save("../data/mock_1_low_derived.npy", pub.derived)
np.save("../data/mock_1_low_lnprobability.npy", pub.lnprobability)
