...
pub = dart_board.DartBoard("NSHMXB", evolve_binary=pybse.evolve, metallicity=LMC_metallicity,
                           ln_prior_pos=sf_history.flat.prior_lmc,
                           nwalkers=320, threads=20, thin=10, ntemps=10,
...
# Save outputs
np.save("../data/J0513_flatsfh_high_chain.npy", pub.chains)
np.save("../data/J0513_flatsfh_high_derived.npy", pub.derived)
np.save("../data/J0513_flatsfh_high_lnprobability.npy", pub.lnprobability)
