...
# Save outputs
np.save("../data/J0513_flatsfh_chain.npy", pub.chains)
np.save("../data/J0513_flatsfh_derived.npy", pub.derived)
np.save("../data/J0513_flatsfh_lnprobability.npy", pub.lnprobability)
