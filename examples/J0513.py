...
pub.throw_darts(nburn=2, nsteps=420000, method='emcee_PT')
...
# Save outputs
np.save("../data/J0513_chain.npy", pub.chains)
np.save("../data/J0513_derived.npy", pub.derived)
np.save("../data/J0513_lnprobability.npy", pub.lnprobability)
