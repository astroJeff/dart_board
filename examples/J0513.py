...
# Pickle results
import pickle
pickle.dump(pub.sampler.chain, open("../data/J0513_chain.obj", "wb"))
pickle.dump(pub.sampler.lnprobability, open("../data/J0513_lnprobability.obj", "wb"))
pickle.dump(pub.binary_data, open("../data/J0513_binary_data.obj", "wb"))
