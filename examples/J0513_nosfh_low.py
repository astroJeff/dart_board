...
# Save outputs
np.save("../data/J0513_nosfh_low_chain.npy", pub.chains)
np.save("../data/J0513_nosfh_low_derived.npy", pub.derived)
np.save("../data/J0513_nosfh_low_lnprobability.npy", pub.lnprobability)
